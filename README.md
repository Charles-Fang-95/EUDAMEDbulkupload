...
> 当前版本 **1.0.2 · 公开测试版**，对应 EUDAMED 官方 XSD **3.0.30**。
> Current version **1.0.2 · Public Beta**, built for EUDAMED official XSD **3.0.30**.
...
当前 **1.0.2 公开测试版 / XSD 3.0.30**。完整变更记录见 [`CHANGELOG.md`](CHANGELOG.md)。
...
Current **1.0.2 Public Beta / XSD 3.0.30**. Full changelog: [`CHANGELOG.md`](CHANGELOG.md).
...
### macOS 1.0.2 与 Original manufacturer
