...
MANUAL_MAPPINGS = {
    ...
    "certificate": {
        "template": "Basic - Certificate Number",
        "status": "needs_design",
        "xml_path": "links:CertificateLinksType / deviceCertificateLinks",
        "notes": "One certificate number is not enough to safely build official certificate links.",
    },
    "is it a kit": {
