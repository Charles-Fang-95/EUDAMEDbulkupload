...
MANUAL_MAPPINGS = {
    ...
    "name of substance": {
        ...
        "status": "implemented",
        "xml_path": "udidi:substances/udidi:substance/udidi:names",
        "notes": "Stored in CMR Substances sheet.",
    },
    "cas": {
        "template": "CMR Substances / CAS Code",
        "status": "implemented",
        "xml_path": "udidi:substances/udidi:substance/udidi:CASCode",
        "notes": "Stored in CMR Substances sheet; exported only for CMR and Endocrine substance types.",
    },
    "ec": {
        "template": "CMR Substances / EC Code",
        "status": "implemented",
        "xml_path": "udidi:substances/udidi:substance/udidi:ECCode",
        "notes": "Stored in CMR Substances sheet; exported only for CMR and Endocrine substance types.",
    },
    "list of cmr substances": {
        "template": "CMR Substances sheet",
        "status": "implemented",
        "xml_path": "udidi:substances",
        "notes": "CMR / endocrine / medicinal / human product substance rows are stored at Basic level and emitted on related UDI-DI XML.",
    },
