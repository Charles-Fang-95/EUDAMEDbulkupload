...
def _build_how_to_use(ws):
    lines = [
        ...
        ("Trade Names、Market Info、Package Info、Critical Warnings、Storage Conditions、CMR Substances 使用独立列填写，不再使用 | 分隔符。", None),
        ...
        ("13. 当前不输出字段", HELP_HEAD),
        ("eIFU URL、Public Email、Certificate Number、Clinical Size、Product Designer、Purpose Other Than Medical 等字段正在做官方字段映射审计；未确认前不会静默写入 XML。", None),
        ("14. 更新 service", HELP_HEAD),
