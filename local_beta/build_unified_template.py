...
def _build_how_to_use(ws):
    lines = [
        ...
        ("11. Special Device Type / CMR Substance", HELP_HEAD),
        ...
        ("14. Device Certificates", HELP_HEAD),
        ...
        ("15. Clinical Sizes / Annex XVI", HELP_HEAD),
        ...
        ("16. 当前不输出字段", HELP_HEAD),
        ("eIFU URL、Public Email、Product Designer 等字段仍在官方字段映射审计中；当前不会写入普通 UDI-DI XML。", None),
        ("17. 更新 service", HELP_HEAD),
