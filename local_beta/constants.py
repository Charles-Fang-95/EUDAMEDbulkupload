...
TOOL_VERSION = "1.0.2"
TOOL_VERSION_LABEL = "1.0.2 · 公开测试版"
TOOL_UPDATED = "2026-09-15"
...
GITEE_RELEASES_API_URL = "https://gitee.com/api/v5/repos/Charles-Fang-95/EUDAMEDbulkupload/releases/latest"
...
UDI_FIELDS = [
    ...
    "Product Designer ID",
    "Product Designer Organisation Name",
    "Product Designer Country",
    "Product Designer Post Code",
    "Product Designer City",
    "Product Designer Street",
    "Product Designer Street Number",
