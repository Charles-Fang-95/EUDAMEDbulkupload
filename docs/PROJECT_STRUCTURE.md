...
| `EUDAMED_Template_v2.10.xlsx` | 当前中文用户模板 | 中文界面首页下载模板默认指向这里 |
| `EUDAMED_Template_v2.10_EN.xlsx` | 当前英文用户模板 | 英文界面下载模板默认指向这里；字段结构与中文模板一致 |
...
正式测试优先使用当前 `EUDAMED_Template_v2.10.xlsx` / `EUDAMED_Template_v2.10_EN.xlsx`，或使用迁移工具生成的 v2.10 样例。
...
- `EUDAMED_Template_v2.10_EN.xlsx`
