...
| `EUDAMED_Template_v2.5.xlsx` | 当前用户模板 | 首页下载模板默认指向这里 |
...
| 路径 | 说明 |
| --- | --- |
| `Test sample/EUDAMED_Customer_Test_Template_Unimax_v2.5.xlsx` | 当前主要内测样例 |
...
正式测试优先使用 `EUDAMED_Customer_Test_Template_Unimax_v2.5.xlsx`。
