...
- `eIFU URL`, `Public Email`, and `Certificate Number` are collected or partly represented, but not safely output to XML yet.
...
| DD BASIC UDI | FLD-UDID-265 | Is it Device a suture, staple, dental filling, dental brace (...)? | 0..1 Property is conditional mandatory only for Devices having Risk Class II b and having the property 'Implantable' | Basic - Is Suture/Staple/Filling/Brace (IIb Implant) | Yes | Payload | Yes | basicudi:IIb_implantable_exceptions | `implemented` | Conditional MDR/MDD field. |
| DD BASIC UDI | FLD-UDID-50 | Clinical Investigations associated to the Basic UDI | 0..n |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-39 | Device Certificate Information associated with the Device | 0..1 | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD BASIC UDI | FLD-UDID-343 | Certificates linked to the Device | 0..n | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
...
| DD BASIC UDI | FLD-UDID-60 | Certificate Type (Technical Documentation, Type Examination, etc) | 1 Occurrence applicable if Device Certificate Inforamtion is provided (FLD-UDID-39) | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD BASIC UDI | FLD-UDID-61 | Certificate Number | 0..1 Occurrence applicable if Device Certificate Inforamtion is provided (FLD-UDID-39) | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD BASIC UDI | FLD-UDID-62 | Revision Number | 0..1 Occurrence applicable if Device Certificate Information is provided (FLD-UDID-39) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-63 | Notified Body | 1 Occurrence applicable if Device Certificate Information is provided (FLD-UDID-39) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-360 | Certificate Type | 1 Occurrence applicable if Certificate Link is provided (FLD-UDID-343) | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD BASIC UDI | FLD-UDID-344 | Certificate Number | 1 Occurrence applicable if Certificate Link is provided (FLD-UDID-343) | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD BASIC UDI | FLD-UDID-345 | Revision Number | 0..1 Occurrence applicable if Certificate Link is provided (FLD-UDID-343) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-346 | Issue Date | 1 Occurrence applicable if Certificate Link is provided (FLD-UDID-343) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-347 | Starting Validity Date | 1 Occurrence applicable if Certificate Link is provided (FLD-UDID-343) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-348 | Expiry Date | 0..1 Occurrence applicable if Certificate Link is provided (FLD-UDID-343) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-349 | Notified Body | 1 Occurrence applicable if Certificate Link is provided (FLD-UDID-343) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-350 | Certificate Status | 1 Occurrence applicable if Certificate Link is provided (FLD-UDID-343) | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD BASIC UDI | FLD-UDID-357 | Decision Date | 0..1 Occurrence applicable if Certificate Link exists (FLD-UDID-343) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-361 | Starting Decision Applicability Date | 0..1 Occurrence applicable if Certificate Link exists (FLD-UDID-343) |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-50 | Clinical Investigations associated to the Basic UDI | 0..n |  | No | No | No |  | `not_in_template` |  |
| DD BASIC UDI | FLD-UDID-39 | Device Certificate Information associated with the Device | 0..1 | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD BASIC UDI | FLD-UDID-343 | Certificates linked to the Device | 0..n | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD BASIC UDI | FLD-UDID-40 | Version | 1 Managed by EUDAMED |  | No | No | No |  | `not_in_template` |  |
...
| DD UDI-DI | FLD-UDID-136 | Secondary (Master) UDI - DI code | 0..1 | UDI-DI Code* | Yes | Yes | Yes | udidi:udiIdentifier/diCode | `implemented` |  |
| DD UDI-DI | FLD-UDID-293 | Issuing Entity Secondary (Master) UDI-DI | 0..1 | Basic - Issuing Entity* | Yes | Yes | Yes | basicudi:basicUDIIdentifier/issuingEntity | `implemented` |  |
...
| DD UDI-DI | FLD-UDID-138 | Direct Marking UDI-DI code | 0..1 | UDI-DI Code* | Yes | Yes | Yes | udidi:udiIdentifier/diCode | `implemented` |  |
| DD UDI-DI | FLD-UDID-294 | Issuing Entity Direct marking DI | 0..1 | Basic - Issuing Entity* | Yes | Yes | Yes | basicudi:basicUDIIdentifier/issuingEntity | `implemented` |  |
...
| DD UDI-DI | FLD-UDID-203 | EC# | 0..1 Occurrence applicable if List of CMR Substances (FLD-UDID-140) is provided |  | No | No | No |  | `not_in_template` |  |
| DD UDI-DI | FLD-UDID-313 | Name of Substance | 0..1 Occurrence applicable if List of Endocrine Substances (FLD-UDID-310) is provided. In case the #CAS, #EC is provided, Name of substance must be provided without the Language |  | No | No | No |  | `not_in_template` |  |
| DD UDI-DI | FLD-UDID-314 | CAS# | 0..1 Occurrence applicable if List of Endocrine Substances (FLD-UDID-310) is provided |  | No | No | No |  | `not_in_template` |  |
| DD UDI-DI | FLD-UDID-315 | EC# | 0..1 Occurrence applicable if List of Endocrine Substances (FLD-UDID-310) is provided |  | No | No | No |  | `not_in_template` |  |
...
| DD UDI-DI | FLD-UDID-317 | Name of Substance | 0..1 Occurrence applicable if List of medicinal product substances (FLD-UDID-311) is provided Not required in case the INN is provided |  | No | No | No |  | `not_in_template` |  |
...
| DD Legacy Devices | FLD-UDID-39 | Device Certificate Information associated with the Device | 0..n Required to be provided for Legacy Devices with the exception of Devices being Class I Devices or Class IVDD General | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
...
| DD Legacy Devices | FLD-UDID-60 | Certificate Type | 1 Occurrence applicable if Device Certificate Information is provided (FLD-UDID-39) | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD Legacy Devices | FLD-UDID-61 | Certificate Number | 1 Occurrence applicable if Device Certificate Information is provided (FLD-UDID-39) Field is required for Legacy Devices | Basic - Certificate Number | Yes | Yes | No | links:CertificateLinksType / deviceCertificateLinks | `needs_design` | One certificate number is not enough to safely build official certificate links. |
| DD Legacy Devices | FLD-UDID-62 | Revision Number | 0..1 Occurrence applicable if Device Certificate Information is provided (FLD-UDID-39) |  | No | No | No |  | `not_in_template` |  |
| DD Legacy Devices | FLD-UDID-63 | Notified Body | 1 Occurrence applicable if Device Certificate Information is provided (FLD-UDID-39) |  | No | No | No |  | `not_in_template` |  |
| DD Legacy Devices | FLD-UDID-64 | Expiry Date | 1 Occurrence applicable if Device Certificate Information is provided (FLD-UDID-39) Field is required for Legacy Devices |  | No | No | No |  | `not_in_template` |  |
...
| DD UDI-DI_SPP | FLD-UDID-136 | Secondary UDI - DI code | 0..1 | UDI - Secondary UDI-DI Code | Yes | Yes | Yes |  | `implemented` |  |
| DD UDI-DI_SPP | FLD-UDID-293 | Issuing Entity Secondary DI | 0..1 | Basic - Issuing Entity* | Yes | Yes | Yes | basicudi:basicUDIIdentifier/issuingEntity | `implemented` |  |
