...
- 当前中文模板是 `EUDAMED_Template_v2.10.xlsx`；英文模板是 `EUDAMED_Template_v2.10_EN.xlsx`。
...
5. 中文界面下载模板，确认下载的是 `EUDAMED_Template_v2.10.xlsx`；英文界面下载模板，确认下载的是 `EUDAMED_Template_v2.10_EN.xlsx`。
6. 导入一个 v2.10 模板样例，确认无 Python traceback。
